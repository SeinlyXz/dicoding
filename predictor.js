...
const fileContent = fs.readFileSync('bustling-brand-444917-m8-77f5a45601aa.json', 'utf-8');
...
const BUCKET_NAME = 'dawam-submissions'; 
const MODEL_PATH = 'models';  // Path to the folder containing model.json and shard files
